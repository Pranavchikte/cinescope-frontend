...
function VerifyEmailContent() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="bg-card/80 backdrop-blur-xl border border-border rounded-lg p-8 shadow-2xl relative overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              {status === "loading" && (
                ...
                >
                  ...
                  >
                    ...
                    <Loader2 className="w-8 h-8 text-primary relative z-10" />
                  </motion.div>
              ...
              {status === "success" && (
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 px-4 py-3 bg-primary/10 border border-primary/20 rounded-lg backdrop-blur-xl">
                ...
                >
                  ...
                  >
                    <Link
                      ...
                      className="inline-flex items-center justify-center w-full px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg font-semibold transition-all duration-200 relative overflow-hidden group"
                    >
                      {/* Ripple effect */}
